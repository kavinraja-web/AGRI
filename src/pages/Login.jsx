      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-sm border border-gray-100">
        ...
        {step === 1 ? (
          <form className="mt-8 space-y-6" onSubmit={handleSendOtp}>
            ...
            >
              {loading ? (
                <><Loader2 className="h-5 w-5 mr-2 animate-spin" /> {t('sendingOtp') || 'Sending...'}</>
              ) : (
                t('sendOtp') || 'Send OTP'
              )}
            </button>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleVerifyOtp}>
            ...
            >
              {loading ? (
                <><Loader2 className="h-5 w-5 mr-2 animate-spin" /> {t('verifying') || 'Verifying...'}</>
              ) : (
                t('verifyLogin') || 'Verify & Log in'
              )}
            </button>
